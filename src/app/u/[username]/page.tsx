...
export default function SendMessage() {
  ...
  return (
    <div className="container mx-auto my-4 sm:my-8 px-4 sm:px-6 py-4 sm:py-6 bg-white rounded max-w-4xl">
      ...
      <div className="space-y-4 my-6 sm:my-8">
        <div className="space-y-2">
          ...
          <p className="text-sm sm:text-base">Click on any message below to select it.</p>
        </div>
        <Card>
          <CardHeader>
            ...
            {error ? (
              ...
              parseStringMessages(completion).map((message, index) => (
                <Button
                  key={index}
                  variant="outline"
                  className="mb-2 text-sm sm:text-base whitespace-normal h-auto py-2 text-left justify-start"
      ...
      <div className="text-center">
        <div className="mb-3 sm:mb-4 text-sm sm:text-base">Get Your Message Board</div>
        <Link href={'/sign-up'}>
